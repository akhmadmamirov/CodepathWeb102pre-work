...
const num_unfundedgames = unfundedGames.length

// create a string that explains the number of unfunded games using the ternary operator
const newString = `A total of $${total_money.toLocaleString('en-US')} has been raised for ${total_games.toLocaleString('en-US')} games.Currently, ${num_unfundedgames.toLocaleString('en-US')} games remain unfunded. We need your help to fund these amazing games!`

// create a new DOM element containing the template string and append it to the description container
descriptionContainer.innerHTML = newString
/************************************************************************************
